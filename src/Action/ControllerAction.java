...
@WebServlet(name = "ControllerAction")
public class ControllerAction extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        super.init(config);
        loadProperties("Property/Command"); // Common properties
    }
    ...
    private void loadProperties(String path) {
        ...
        while (actionEnumHome.hasMoreElements()) {
            ...
            try {
                ...
                Object commandInstance = commandClass.getDeclaredConstructor().newInstance(); // 해당 클래스의 객체를 생성
